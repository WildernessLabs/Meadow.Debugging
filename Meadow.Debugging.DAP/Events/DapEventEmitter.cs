...
namespace Meadow.Debugging.DAP.Events
{
    /// <summary>
    /// DAP implementation of IDebugEventEmitter.
    /// Translates platform-agnostic events to standard DAP events.
    /// This implementation works with any DAP-compliant client (VSCode, VS2022, Rider, etc.).
    /// </summary>
